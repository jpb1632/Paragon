  ...
  const CONTENT_CONFIG = {
    business: {
      ...
      location: {
        ...
        copy: "1호선 회천중앙역(예정)&GTX-C(예정) 연계 및 3번국도 대체우회도로·수도권제2순환도로로 서울 및 강남 접근성 우수",
    ...
    complex: {
      ...
      community: {
        subtitle: "커뮤니티",
        copy: "실내골프연습장·피트니스·GX룸부터 북카페·키즈룸·단지 내 어린이집까지 원스톱 완비",
      ...
      siteplan: {
        subtitle: "단지배치도",
        copy: "선호도 높은 72㎡·84㎡ 총 845세대 전세대 남향 위주 배치와 덕계천 수변공원으로 곧바로 연결되는 보행자 출입구",
